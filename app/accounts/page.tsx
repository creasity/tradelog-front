          ...
          <div className="space-y-2">
            ...
            {editInfo ? (
              <div className="bg-light-surface dark:bg-dark-surface rounded-xl p-4 space-y-3 border border-light-border dark:border-dark-border">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="sm:col-span-2">
                    ...
                    <input className="tl-input" value={info.name} onChange={e => setInfo(i => ({ ...i, name: e.target.value }))} />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <input className="tl-input" type="number" step="any" value={info.initial_balance} onChange={e => setInfo(i => ({ ...i, initial_balance: e.target.value }))} />
                  </div>
                  <div className="sm:col-span-2">
                    <label className="tl-label">Notes</label>
                    <textarea className="tl-input resize-none h-16 text-xs" value={info.notes} onChange={e => setInfo(i => ({ ...i, notes: e.target.value }))} />
                  </div>
                </div>
              ...
              <div className="text-xs font-mono space-y-1">
                {account.notes && (
                  <p className="text-gray-500 italic">{account.notes}</p>
                )}
              </div>
            )}
          </div>
...
export default function AccountsPage() {
  ...
  return (
    <AppLayout title="Comptes de Trading" subtitle="Gestion de vos comptes & synchronisation">
